...
const ROICalculator = ({ results, assessment }) => {
  ...
  const calculateROI = () => {
    ...
    // Enterprise Platform investment (simplified)
  ...
  return (
    <CalculatorContainer>
      <CalculatorHeader>
        ...
        <CalculatorSubtitle>
          Customize assumptions to see your specific business case for Enterprise Platform
        </CalculatorSubtitle>
      </CalculatorHeader>
      ...
      <InfoBox>
        ...
        <InfoText>
          <strong>How we calculate ROI:</strong> Based on industry benchmarks from Forrester Total Economic Impact studies and Enterprise Platform customer case studies. 
