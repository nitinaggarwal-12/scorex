        ...
        <SlideContent data-slide-content="true">
          <div style={{
            ...
            <p style={{
              ...
              Everything you need to know about the Enterprise Platform Technical Maturity Assessment tool
            </p>
          </div>
        </SlideContent>
      );
          ...
          <div style={{
            ...
            <div>
              ...
              <TroubleshootCard>
                ...
                <TroubleshootSolution>
                  <strong>Contact Support:</strong> For issues not covered here, reach out to <strong>nitin.aggarwal@Enterprise Platform.com</strong> with your assessment ID, role, and a description of the problem. Include screenshots if possible.
                </TroubleshootSolution>
              </TroubleshootCard>
            </div>
          </div>
