...
const Dashboard = () => {
  ...
  const handleExport = () => {
    try {
      ...
      // Build CSV content
      let csvContent = 'SCOREX MATURITY ASSESSMENT - DASHBOARD DATA\n';
      ...
      link.setAttribute('download', `scorex-dashboard-insights-${timestamp}.csv`);
            ...
            <SlideContent>
              {currentSlide === 0 && (
                <div style={{
                  ...
                  >
                    Real-time analytics across all enterprise maturity assessments
                  </motion.p>
                  <motion.div
                    initial={{ y: 20, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
