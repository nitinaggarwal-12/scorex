    ...
    <PageContainer>
      ...
      <Section id="why-assessment">
        <SectionHeader>
          ...
          <p>Gain clarity on your Enterprise Platform journey and unlock the full potential of your data and AI initiatives.</p>
        </SectionHeader>
      ...
      <Section id="pillars" className="alt-bg">
        <SectionHeader>
          ...
          <p>Evaluate your Enterprise Platform maturity across these six comprehensive pillars. Each contains five dimensions with targeted questions.</p>
        </SectionHeader>
        ...
        <Grid className="three-columns">
          ...
          >
            ...
            <div className="pillar-desc">
              Assess how well your enterprise data & AI foundation is secured, scalable, and governed.
            </div>
          ...
          >
            ...
            <div className="pillar-desc">
              Evaluate how efficiently data is ingested, transformed, and managed within Enterprise Platform.
            </div>
            <div className="dimensions-label">Dimensions:</div>
            <div className="dimensions">
          ...
          >
            ...
            <div className="pillar-desc">
              Assess how Enterprise Platform supports governed analytics, performance, and self-service access.
            </div>
            <div className="dimensions-label">Dimensions:</div>
            <div className="dimensions">
          ...
          >
            ...
            <div className="pillar-desc">
              Understand how Enterprise Platform is leveraged for classical and predictive ML use cases with reliable operations.
            </div>
            <div className="dimensions-label">Dimensions:</div>
            <div className="dimensions">
          ...
          >
            ...
            <div className="pillar-desc">
              Measure organizational readiness, adoption velocity, and realized value from Enterprise Platform.
            </div>
            <div className="dimensions-label">Dimensions:</div>
            <div className="dimensions">
