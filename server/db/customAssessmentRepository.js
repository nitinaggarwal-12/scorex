...
const STARTER_PRODUCTION_TEMPLATES = [
  {
    ...
    "title": "Gemini Enterprise Migration Assessment",
    "subtitle": "Enterprise GenAI Architecture Modernization & Cost Arbitrage",
    "description": "Comprehensive evaluation for modernizing enterprise GenAI workloads to Google Gemini Enterprise on Vertex AI, covering prompt compatibility, long context, context caching, security, and agentic orchestration.",
    "icon": "HiSparkles",
    "badge": "Gemini Migration",
    "color": "#8b5cf6",
    "status": "production",
    "isPublished": true,
    "isPromoted": true,
    ...
    "framework": {
      ...
      "title": "Gemini Enterprise Migration Assessment",
      "subtitle": "Enterprise GenAI Architecture Modernization & Cost Arbitrage",
      "description": "Evaluate technical feasibility, prompt modernization, long-context window optimization, token cost arbitrage, VPC security, and multi-agent mesh for Google Gemini Enterprise.",
      "icon": "HiSparkles",
      "badge": "Gemini Migration",
      "color": "#8b5cf6",
  ...
  },
  {
    ...
    "title": "BigQuery Lakehouse Modernization",
    "subtitle": "Open Storage (Iceberg), Predictable Slots & Zero-Egress Analytics",
    "description": "Comprehensive 10-question evaluation for modernizing enterprise data warehouses to BigQuery + BigLake open lakehouse architecture with predictable Editions pricing and unified Dataplex governance.",
    "icon": "HiDatabase",
