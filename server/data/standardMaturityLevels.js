// Standardized Maturity Levels for Enterprise Platform Assessment
...
function getExperimentLabel(context) {
  const labels = {
    ...
    'governance': 'Unified Data Catalog & Governance partially implemented, incomplete metadata',
    ...
    'orchestration': 'Using Enterprise Platform Jobs, but manual failure handling',
    ...
    'ml_lifecycle': 'Enterprise Model Registry tracking experiments, but not all projects use it',
    ...
    'genai_adoption': 'Teams experimenting with OpenAI API or enterprise data & AI foundation Models',
...
function getFormalizeLabel(context) {
  const labels = {
    ...
    'security': 'Unified Data Catalog & Governance fully implemented, automated compliance checks',
    'monitoring': 'Centralized observability with Enterprise Platform System Tables and custom dashboards',
    ...
    'orchestration': 'Enterprise Platform Workflows with automated retries and error handling',
    ...
    'ml_lifecycle': 'Enterprise Model Registry used consistently, experiments tracked and reproducible',
    ...
    'genai_adoption': 'Production GenAI applications with Enterprise Platform Model Serving',
