// Standardized Maturity Levels for Enterprise Data & AI Maturity Assessment
...
function getExploreLabel(context) {
  const labels = {
    ...
    'genai_adoption': 'Exploring consumer GenAI tools individually',
    'genai_architecture': 'No dedicated enterprise GenAI infrastructure',
...
function getExperimentLabel(context) {
  const labels = {
    ...
    'authentication': 'Basic SSO implemented, but inconsistent RBAC across accounts',
    ...
    'governance': 'Unified catalog partially implemented, incomplete metadata',
    'cost': 'Basic cost reports available, but no optimization actions',
    'ingestion': 'Mix of streaming loaders and custom scripts, not standardized',
    'architecture': 'Multi-hop layers partially implemented, no clear standards',
    'orchestration': 'Scheduled batch jobs, but manual failure handling',
    ...
    'consumption': 'SQL endpoints available, but most users still rely on manual extracts',
    ...
    'ml_lifecycle': 'Experiment tracking tool in place, but not all projects use it',
    ...
    'genai_adoption': 'Teams experimenting with external LLM APIs and open foundation models',
...
function getFormalizeLabel(context) {
  const labels = {
    ...
    'security': 'Unified governance catalog fully implemented, automated compliance checks',
    'monitoring': 'Centralized observability with platform system telemetry and custom dashboards',
    ...
    'ingestion': 'Standardized declarative pipelines for all structured and unstructured ingestion',
    'architecture': 'Full structured multi-tier lakehouse architecture (Raw/Cleaned/Curated) implemented',
    'orchestration': 'Enterprise workflow orchestration with automated retries and error handling',
    ...
    'ml_lifecycle': 'MLOps tracking used consistently, experiments tracked and reproducible',
    ...
    'genai_adoption': 'Production GenAI applications with managed model serving',
