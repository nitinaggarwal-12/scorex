  ...
  dimensions: [
    {
      ...
      questions: [
        {
          id: 'coe_structure',
          question: 'How formally is your CoE structured to define enterprise data & AI standards and best practices?',
          perspectives: [
            {
              id: 'current_state',
              label: 'Current State',
      ...
      questions: [
        {
          ...
          question: 'How strong is the internal collaboration and knowledge-sharing culture across data & AI practitioners?',
          perspectives: [
            {
              id: 'current_state',
              label: 'Current State',
      ...
      questions: [
        {
          ...
          question: 'How comprehensive are your platform enablement programs for engineers, analysts, and data scientists?',
          perspectives: [
            {
              id: 'current_state',
              label: 'Current State',
    ...
    },
    {
      ...
      questions: [
        {
          id: 'value_linkage',
          question: 'How clearly are data & cloud compute costs linked to business value or productivity gains?',
          perspectives: [
            {
              id: 'current_state',
              label: 'Current State',
            ...
            },
            {
              ...
              type: 'multiple_choice',
              options: [
                { value: 'roi_unclear', label: 'Unclear ROI on Data & AI investments', score: 4 },
      ...
      questions: [
        {
          ...
          question: 'How proactive is your organization in evaluating and piloting new data & AI platform capabilities?',
          perspectives: [
            {
              id: 'current_state',
              label: 'Current State',
