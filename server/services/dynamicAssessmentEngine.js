...
2. DESIRED FUTURE STATE ARCHITECTURE (Target State): The modern, governed, highly scalable Lakehouse & Compound AI Mesh architecture (Unity Catalog, Serverless FinOps, Streaming CDC, Model Context Protocol (MCP), and Prompt Context Caching).
...
- Every swimlane must have 'style="swimlane;html=1;startSize=44;fillColor=...;strokeColor=...;..."'
- All card nodes must have 'style="rounded=1;whiteSpace=wrap;html=1;fillColor=...;strokeColor=...;..."'
- For CURRENT STATE: Use dark reddish/amber/slate palette (fillColor=#311018, strokeColor=#f43f5e, fontColor=#ffffff, title #f87171). Include 4 distinct stages with realistic components and ⚠️ warning/alert badges with quantified pain points.
- For DESIRED FUTURE STATE: Use modern emerald/teal/indigo palette (fillColor=#064e3b, strokeColor=#10b981, fontColor=#ffffff, title #34d399). Include 4 distinct stages with modern technologies (Streaming CDC, Delta/Iceberg, Unity Catalog, Photon FinOps, MCP Multi-Agent Mesh, Prompt Caching) and ✓ value badges.
...
{
  "reasoning": "<2-3 sentence architectural explanation of the transformation journey tailored to this customer>",
  ...
  "targetTitle": "<Title for Target State, e.g. Desired Future State: Modern Unified Lakehouse & Autonomous Agentic Mesh>",
  "targetSubtitle": "<Subtitle, e.g. Target Maturity Level 4.5 (Optimized) • Sub-Second Streaming • Unity Catalog FinOps>",
  ...
  "keyTransformations": [
    ...
    "<Key shift 2: e.g. Siloed buckets -> Unity Catalog open table formats (Delta/Iceberg)>",
    "<Key shift 3: e.g. Static 24/7 VMs -> Serverless FinOps Photon compute with 15-min kill switches>",
    "<Key shift 4: e.g. Unguarded APIs -> Model Context Protocol (MCP) Multi-Agent Mesh with 75% prompt caching>"
  ]
}`;
  ...
  _generateDeterministicDiagramsFallback(framework, metadata = {}, scores = {}) {
    ...
    return {
      reasoning: `Comprehensive architectural transformation blueprint for ${cust}, migrating from legacy fragmented data stores and batch scripts to a unified open Lakehouse and autonomous agent mesh.`,
      ...
      targetTitle: `Desired Future State: Modern Lakehouse & Agentic Mesh (${cust})`,
      targetSubtitle: `Target Maturity Level ${tgt}/5.0 (Optimized) • Streaming CDC • Unity Catalog • Serverless FinOps`,
