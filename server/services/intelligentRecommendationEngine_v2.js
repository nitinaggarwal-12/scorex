...
const platformFeatureMapper = require('./databricksFeatureMapper');
const featureDB = require('./databricksFeatureDatabase');

class IntelligentRecommendationEngine {
  constructor() {
    this.featureMapper = platformFeatureMapper;
    this.featureDB = featureDB;
    
    // KEYWORD → Enterprise Platform FEATURE/SOLUTION MAPPING
    this.keywordMap = {
      // Governance & Security
      'coe': {
        features: ['Unified Data Catalog & Governance', 'Account Console', 'System Tables', 'Enterprise Platform Academy'],
        solution: 'Establish Center of Excellence with Unified Data Catalog & Governance governance framework, System Tables for tracking, and Enterprise Platform Academy for training',
        category: 'governance'
      },
      'governance': {
        features: ['Unified Data Catalog & Governance', 'Audit Logs', 'Compliance Security Profile', 'Data Classification'],
        solution: 'Implement Unified Data Catalog & Governance for centralized governance with automated audit logging and compliance controls',
        category: 'governance'
      },
      'security': {
        features: ['Unified Data Catalog & Governance', 'Private Link', 'Customer-Managed Keys', 'IP Access Lists'],
        solution: 'Deploy network isolation with Private Link, encrypt data with customer-managed keys, and enforce IP allowlists',
        category: 'security'
      },
      'access': {
        features: ['Unified Data Catalog & Governance', 'RBAC', 'ABAC', 'Service Principals'],
        solution: 'Configure role-based and attribute-based access control via Unified Data Catalog & Governance with service principal automation',
        category: 'security'
      },
      'sharing': {
        features: ['Delta Sharing', 'Enterprise Platform Marketplace', 'Clean Rooms', 'Unified Data Catalog & Governance'],
        solution: 'Enable secure data sharing with Delta Sharing for external partners, Enterprise Platform Marketplace for data monetization, and Clean Rooms for privacy-preserving collaboration',
        category: 'governance'
      },
      'marketplace': {
        features: ['Enterprise Platform Marketplace', 'Delta Sharing', 'Lakehouse Apps', 'Partner Connect'],
        solution: 'Monetize data assets via Enterprise Platform Marketplace, share securely with Delta Sharing, and distribute AI apps with Lakehouse Apps',
        category: 'governance'
      },
      'monetization': {
        features: ['Enterprise Platform Marketplace', 'Delta Sharing', 'Data Products', 'Unified Data Catalog & Governance'],
        solution: 'Build data products with Unified Data Catalog & Governance, monetize via Enterprise Platform Marketplace, and enable secure consumption with Delta Sharing',
        category: 'governance'
      },
      'collaboration': {
        features: ['Delta Sharing', 'Clean Rooms', 'Enterprise Platform Marketplace', 'Lakehouse Federation'],
      ...
      // Training & Enablement
      'training': {
        features: ['Enterprise Platform Academy', 'Partner Training', 'Community Edition', 'Certification Programs'],
        solution: 'Scale enablement with Enterprise Platform Academy online courses, partner-led workshops, and hands-on labs',
        category: 'enablement'
      },
      'adoption': {
        features: ['Enterprise AI Advisor', 'Quickstart Templates', 'Solution Accelerators', 'Community'],
        solution: 'Accelerate adoption with AI Assistant for code generation, pre-built templates, and community support',
        category: 'enablement'
      },
      'learning': {
        features: ['Enterprise Platform Academy', 'Documentation', 'Enterprise Platform University', 'Hands-on Labs'],
        solution: 'Provide continuous learning through Academy courses, comprehensive docs, and hands-on practice environments',
        category: 'enablement'
      },
      'knowledge': {
        features: ['Enterprise AI Advisor', 'Documentation', 'Community Forums', 'Solution Accelerators'],
      ...
      'monitoring': {
        features: ['Continuous Data Observability', 'System Tables', 'Audit Logs', 'Enterprise SQL Warehouse Dashboards'],
        solution: 'Implement comprehensive monitoring with Continuous Data Observability for data quality and System Tables for usage tracking',
        category: 'observability'
      },
      'observability': {
        features: ['Continuous Data Observability', 'System Tables', 'Audit Logs', 'Query History'],
        solution: 'Build observability stack with Continuous Data Observability, System Tables analysis, and audit log review',
        category: 'observability'
      },
      'logging': {
      ...
      'alerting': {
        features: ['Budget Alerts', 'Workflow Notifications', 'Continuous Data Observability Alerts', 'SQL Alerts'],
      ...
      'version': {
        features: ['Git Integration', 'Repos', 'Enterprise Platform Asset Bundles', 'Enterprise Model Registry Model Versions'],
      ...
      'quality': {
        features: ['Declarative Data Pipelines Expectations', 'Continuous Data Observability', 'Data Quality Checks', 'Great Expectations'],
        solution: 'Enforce data quality with DLT expectations, monitor with Continuous Data Observability, and validate with quality checks',
        category: 'data_engineering'
      },
      'ingestion': {
      ...
      // Machine Learning
      'experiment': {
        features: ['Enterprise Model Registry Tracking', 'Enterprise Model Registry Experiments', 'AutoML', 'Enterprise Platform Notebooks'],
        solution: 'Track all experiments with Enterprise Model Registry autologging, compare runs in UI, and accelerate with AutoML',
        category: 'machine_learning'
      },
      'model': {
        features: ['Mosaic AI Model Serving', 'Enterprise Model Registry Model Registry', 'Feature Engineering', 'Continuous Data Observability'],
        solution: 'Deploy models with Mosaic AI Model Serving for production-grade inference, manage lifecycle with Enterprise Model Registry Registry, and monitor with Continuous Data Observability',
        category: 'machine_learning'
      },
      'serving': {
      ...
      'feature': {
        features: ['Feature Engineering in Unified Data Catalog & Governance', 'Online Tables', 'Feature Serving'],
        solution: 'Centralize features in Unified Data Catalog & Governance Feature Engineering, serve with low-latency Online Tables for real-time ML',
        category: 'machine_learning'
      },
      'online': {
      ...
      'agent': {
        features: ['Mosaic AI Agent Framework', 'Mosaic AI Agent Evaluation', 'Compound AI Systems', 'Enterprise Model Registry AI Gateway'],
        solution: 'Build compound AI systems with Mosaic AI Agent Framework, evaluate quality with Agent Evaluation, and orchestrate with Enterprise Model Registry',
        category: 'genai'
      },
      'prompt': {
        features: ['AI Playground', 'Enterprise Model Registry', 'Mosaic AI Gateway', 'Prompt Engineering Tools'],
        solution: 'Develop prompts in AI Playground, version with Enterprise Model Registry, monitor quality with Mosaic AI Gateway, and optimize costs',
        category: 'genai'
      },
      'vector': {
      ...
      'evaluation': {
        features: ['Mosaic AI Agent Evaluation', 'Enterprise Model Registry Evaluate', 'AI Playground', 'LLM Judges'],
        solution: 'Evaluate GenAI quality with Mosaic AI Agent Evaluation for multi-turn conversations, Enterprise Model Registry for metrics tracking, and LLM judges for automated assessment',
        category: 'genai'
      },
      
      // Analytics & BI
      'dashboard': {
        features: ['Enterprise SQL Warehouse Dashboards', 'Genie', 'Power BI Connector', 'Tableau Integration'],
        solution: 'Build dashboards with Enterprise SQL Warehouse for internal users, Genie for natural language, and BI connectors for external tools',
        category: 'analytics'
      },
      'reporting': {
        features: ['Enterprise SQL Warehouse', 'Scheduled Queries', 'Alerts', 'Dashboard Sharing'],
      ...
      'visualization': {
        features: ['Enterprise SQL Warehouse Dashboards', 'Genie', 'Partner Connectors', 'Python Visualization Libraries'],
    ...
    this.solutionMap = {
      ...
      'no_coe': {
        ...
        solution: 'Establish Enterprise Platform CoE with dedicated team (2-3 platform engineers, 1 data architect), Unified Data Catalog & Governance governance framework, System Tables for adoption tracking, and Enterprise Platform Academy for continuous training.',
        recommendations: [
          ...
          '**Staff CoE team**: Assign 2-3 platform engineers for infrastructure, 1 data architect for design patterns, and leverage Enterprise Platform Professional Services for 3-month onboarding',
          '**Deploy Unified Data Catalog & Governance**: Centralize data governance with metastore, implement RBAC for access control, enable audit logging for compliance, and create data classification tags',
          '**Launch training program**: Enroll 20 users in Enterprise Platform Academy (Fundamentals, Data Engineering, ML), conduct monthly office hours, build internal knowledge base with runbooks',
        ...
        platform_features: ['Unified Data Catalog & Governance', 'Enterprise Platform Academy', 'Account Console', 'System Tables', 'Professional Services'],
        next_steps: [
          'Workshop: CoE Design & Roadmap with stakeholders (1 day)',
          'Assessment: Current state gaps vs. target operating model',
          'Engagement: Enterprise Platform Professional Services for CoE setup (3 months)',
          'Training: Enterprise Platform Academy enrollment for 20 initial users',
          'Implementation: Unified Data Catalog & Governance deployment with pilot use case (4 weeks)'
        ]
      },
      
      'unclear_charter': {
        problem: 'Unclear CoE charter and responsibilities',
        solution: 'Define clear CoE charter with three pillars: Governance (Unified Data Catalog & Governance policies), Enablement (training/support), Innovation (Labs/POCs). Establish RACI matrix, SLAs, and quarterly review process.',
        recommendations: [
          '**Document CoE charter**: Define pillars - Governance (Unified Data Catalog & Governance, audit logs, compliance), Enablement (training, support, best practices), Innovation (evaluate new features, POCs, Labs tools)',
        ...
        platform_features: ['Unified Data Catalog & Governance', 'System Tables', 'Account Console', 'Enterprise Platform Academy', 'Continuous Data Observability'],
        next_steps: [
          'Workshop: CoE Charter Definition with exec sponsors and stakeholders',
          'Consulting: Enterprise Platform Customer Success for CoE best practices',
      ...
      'resource_constraints': {
        ...
        solution: 'Augment CoE with Enterprise Platform Professional Services (3-6 month engagement), partner SI resources (2-3 consultants), Enterprise Platform Academy for scalable training, and community support channels.',
        recommendations: [
          '**Engage Enterprise Platform Professional Services**: 3-6 month engagement for platform setup, Unified Data Catalog & Governance design, migration strategy, performance optimization, and CoE team training',
          '**Partner with System Integrator**: Augment CoE with 2-3 consultants from Slalom, Deloitte, Accenture, or Enterprise Platform partners for surge capacity and specialized skills',
          '**Scale training via Academy**: Enterprise Platform Academy online courses for self-paced learning (100+ courses), monthly group training sessions, quarterly certification push',
          '**Leverage Enterprise Platform Community**: Forums for peer support, Slack channels for real-time help, user group meetups, GitHub repos with sample code and best practices',
          '**Build self-service platform**: Quickstart templates, Solution Accelerators, documented runbooks, Enterprise AI Advisor for code generation, reducing CoE support burden'
        ],
        platform_features: ['Professional Services', 'Enterprise Platform Academy', 'Partner Network', 'Community', 'Solution Accelerators'],
        next_steps: [
          'Engagement: Enterprise Platform Professional Services scoping call and SOW',
          'RFP: System integrator partners for CoE augmentation (2-4 week selection)',
          'Enrollment: Enterprise Platform Academy licenses for 50 users',
      ...
      'standards_gaps': {
        ...
        solution: 'Create comprehensive standards: Enterprise Platform Asset Bundles for IaC, cluster policies for compute governance, Unified Data Catalog & Governance for data standards, naming conventions, and automated compliance checks.',
        recommendations: [
          ...
          '**Data standards via Unified Data Catalog & Governance**: Naming conventions (bronze/silver/gold), classification tags (PII, sensitive), quality tiers (certified/uncertified), retention policies',
          ...
          '**Security standards**: No storage credentials in code (use Unified Data Catalog & Governance), service principals for automation, IP allowlists for sensitive workspaces, audit log monitoring'
        ],
        platform_features: ['Asset Bundles', 'Cluster Policies', 'Unified Data Catalog & Governance', 'Audit Logs', 'Git Integration'],
        next_steps: [
      ...
      'adoption_challenges': {
        ...
        solution: 'Drive adoption with Enterprise AI Advisor for code generation from standards, Solution Accelerators as reference implementations, gamification (leaderboards, badges), and executive sponsorship.',
        recommendations: [
          '**Make standards easy**: Enterprise AI Advisor trained on your standards generates compliant code, quickstart templates with standards baked in, one-click setup for common patterns',
          ...
          '**Embed in onboarding**: New team members complete standards training (Enterprise Platform Academy custom course) before platform access, pair with mentor for first project',
        ...
        platform_features: ['Enterprise AI Advisor', 'Solution Accelerators', 'System Tables', 'Enterprise Platform Academy', 'Quickstart Templates'],
        next_steps: [
          'Development: Quickstart templates for top 5 use cases',
          'Training: Custom Enterprise Platform Academy course on your standards',
  ...
  smartFallback(painPoint, pillarId) {
    ...
    return {
      ...
      recommendations: [
        `Recommended Enterprise Platform products/features: ${keywordData.features.join(', ')}`
      ],
      platform_features: keywordData.features
  ...
  generateTechnicalImplementation(primaryFeature, secondaryFeature, painPointLabel, category) {
    ...
    const technicalMappings = {
      'Unified Data Catalog & Governance': {
        steps: [
          '• Deploy Unified Data Catalog & Governance metastore via REST API: \`POST /api/2.1/unity-catalog/metastores\` with AWS S3/Azure ADLS/GCS root storage configuration',
        ...
        complexity: '4-6 weeks, requires Enterprise Platform Certified Associate + security/IAM expertise + Terraform/IaC skills',
      ...
      'Declarative Data Pipelines': {
        ...
        prerequisites: 'Enterprise Platform Runtime 11.3+, Unified Data Catalog & Governance enabled, source data in Delta format, version control (Git)'
      },
      'Enterprise Model Registry': {
        steps: [
          '• Configure Enterprise Model Registry Tracking Server with backend store: \`Enterprise Model Registry.set_tracking_uri("Enterprise Platform")\` and artifact store in Unified Data Catalog & Governance volumes',
          '• Implement experiment tracking with autologging: \`Enterprise Model Registry.autolog()\` for scikit-learn/XGBoost/TensorFlow with hyperparameter capture',
          '• Register models in Unified Data Catalog & Governance: \`Enterprise Model Registry.register_model(f"runs:/{run_id}/model", "catalog.schema.model_name")\` with versioning and aliases',
        ...
        prerequisites: 'Enterprise Platform ML Runtime, Unified Data Catalog & Governance, Model Registry access, production endpoint permissions'
      },
      'Enterprise SQL Warehouse': {
        ...
        prerequisites: 'Enterprise SQL Warehouse Pro/Serverless, Unified Data Catalog & Governance with SELECT grants, Photon enabled, Serverless GA (Q2 2024)'
      },
      'Model Serving': {
        steps: [
          ...
          '• Configure AI Gateway for rate limiting, PII detection: \`POST /api/2.0/serving-endpoints/{name}/config\` with Continuous Data Observability integration',
        ...
        prerequisites: 'Enterprise Platform ML Runtime, registered models in Unified Data Catalog & Governance, production workspace, Serverless Compute GA'
      },
      'Workflows': {
        steps: [
        ...
        prerequisites: 'Enterprise Platform Jobs access, Git integration enabled, service principal for automation, Unified Data Catalog & Governance for secrets'
      }
    };
    ...
    const implementation = technicalMappings[primaryFeature] || {
      steps: [
        `• Deploy ${primaryFeature} via Enterprise Platform REST API (\`/api/2.1/...\`) with OAuth 2.0 service principal authentication`,
        `• Configure ${secondaryFeature} integration using infrastructure-as-code (Enterprise Platform Asset Bundles or Terraform Provider)`,
        `• Implement monitoring and observability with System Tables (\`system.compute.*\`, \`system.billing.*\`) and Continuous Data Observability`,
      ...
      complexity: '3-6 weeks | Requires: Enterprise Platform Certified Associate + platform engineering + DevOps + cloud architecture',
      prerequisites: 'Account/Workspace admin, Unified Data Catalog & Governance, cloud IAM roles (AWS/Azure/GCP), Git repository, CI/CD platform'
    };
  ...
  pillarDefaultRecommendation(painPoint, pillarId) {
    const pillarDefaults = {
      'platform_governance': {
        features: ['Unified Data Catalog & Governance', 'Account Console', 'Audit Logs', 'Cluster Policies'],
        apiEndpoints: [
      ...
      'data_engineering': {
        features: ['Declarative Data Pipelines', 'Workflows', 'Auto Loader', 'Continuous Data Observability'],
        apiEndpoints: [
        ...
        complexity: '4-6 weeks | Requires: PySpark + Enterprise Platform Runtime 13.3+ + DataOps/DevOps skills',
        latestFeature: 'DLT Serverless + Predictive I/O - GA Q1 2024'
      },
      'analytics_bi': {
        features: ['Enterprise SQL Warehouse', 'Photon', 'Genie', 'Liquid Clustering'],
        apiEndpoints: [
        ...
        complexity: '3-5 weeks | Requires: SQL tuning + Unified Data Catalog & Governance + BI tool integration (Tableau/Power BI)',
        latestFeature: 'Genie (AI Analyst) + Serverless SQL GA - Q2 2024'
      },
      'machine_learning': {
        features: ['Enterprise Model Registry', 'Feature Store', 'Model Serving', 'Continuous Data Observability'],
        apiEndpoints: [
          '\`Enterprise Model Registry.register_model("runs:/{run_id}/model", "catalog.schema.model")\` - Version models in Unified Data Catalog & Governance',
        ...
        latestFeature: 'Serverless Model Serving + Continuous Data Observability for ML - GA Q1 2024'
      },
      'generative_ai': {
        ...
        apiEndpoints: [
          ...
          '\`Enterprise Model Registry.langchain.log_model()\` - Register RAG chain in Model Registry with Agent Evaluation framework',
      ...
      'operational_excellence': {
        features: ['Unified Data Catalog & Governance', 'System Tables', 'Enterprise Platform Academy', 'Asset Bundles'],
        apiEndpoints: [
          '\`SELECT * FROM system.compute.clusters WHERE date >= current_date() - 30\` - Analyze compute utilization',
          '\`Enterprise Platform bundle deploy\` - Deploy infrastructure-as-code with Asset Bundles (YAML + Git)',
        ...
        latestFeature: 'Enterprise Platform Asset Bundles (DABs) + Enhanced System Tables - GA Q4 2023'
      }
    };
    ...
    return {
      problem: painPoint.label,
      solution: `Deploy ${defaults.features.join(', ')} with production-grade architecture, security, and monitoring. Implementation requires deep Enterprise Platform platform expertise and infrastructure-as-code patterns.`,
      recommendations: [
        `**Technical Architecture for ${painPoint.label}**:`,
        ...defaults.apiEndpoints,
      ],
      platform_features: defaults.features
      // Note: High-level Next Steps are handled by buildContextualNextSteps() using nextStepsLibrary
    };
  }
  ...
  async generateRecommendations(assessment, pillarId, pillarFramework) {
    ...
    if (dbFeatures.length > 0) {
      ...
      for (const painPoint of topPainPoints) {
        ...
        if (solution) {
          ...
          if (solution.enterprisePlatform_features) {
            solution.enterprisePlatform_features.forEach(f => featureSet.add(f));
          }
        }
      }
    ...
    // 🚀 BUILD Enterprise Platform FEATURES from database
    let painPointFeatures;
    if (dbFeatures.length > 0) {
      console.log(`[IntelligentEngine V2] ✅ Building ${dbFeatures.length} Enterprise Platform Features from DATABASE`);
      ...
      painPointFeatures = dbFeatures.map((f, featureIndex) => {
        ...
        if (relatedComment && relatedComment.comment) {
          ...
          const uniqueReasonMap = {
            ...
            'Continuous Data Observability': 'Automated monitoring for data quality, schema changes, and model performance',
            ...
            'Unified Data Catalog & Governance for AI': 'Govern AI models, prompts, and feature sets with centralized catalog',
            
            // ML Features
            'Enterprise Model Registry': 'End-to-end ML lifecycle management with experiment tracking and model registry',
            ...
            'Unified Data Catalog & Governance': 'Unified governance for data and AI assets with centralized access control',
            ...
            'Enterprise SQL Warehouse': 'Powerful SQL analytics with native BI integrations',
            ...
            'Enterprise Platform Academy': 'Free online training and certification programs for platform adoption',
            'Professional Services': 'Expert consulting for architecture, migrations, and best practices',
            'Community Edition': 'Free access to Enterprise Platform for learning and experimentation',
            ...
            'Enterprise Platform Asset Bundles': 'Infrastructure-as-code for deployment automation',
      ...
      const mlFeatures = ['Enterprise Model Registry', 'Feature Store', 'Model Registry', 'Model Serving', 'AutoML'];
      ...
      if (pillarId === 'data_engineering') {
        ...
        // Platform should NOT have GenAI-specific features (but can have Unified Data Catalog & Governance, Audit Logs, etc.)
    ...
    return {
      ...
      platformFeatures: painPointFeatures.slice(0, 8) // 🔥 FIXED: Max 8 features as requested
    };
  }
  ...
  async buildRecommendationFromDatabase(feature, featureDetails) {
    try {
      ...
      const recommendation = {
        title: feature.name,
        description: feature.detailed_description || feature.description || 'Advanced Enterprise Platform capability to address your technical challenges',
        benefits: benefits,
      ...
      if (featureDetails && featureDetails.capabilities) {
        ...
        recommendation.technicalDetails = {
          ...
          prerequisites: tech.prerequisites || 'enterprise workspace with appropriate permissions',
          ...
          platformCLI: tech.enterprisePlatform_cli_command
        };
  ...
  async buildContextualNextSteps(assessment, pillarId, painPoints, comments, stateGaps, features) {
    ...
    const nextStepsLibrary = {
      platform_governance: [
        ...
        'Workshop: Conduct a Platform Governance & Unified Data Catalog & Governance Workshop with Enterprise Platform SMEs to align architecture, access models, and catalog strategy',
      ...
      analytics_bi: [
        'Workshop: Run a Modern BI on Lakehouse Workshop (Enterprise SQL Warehouse + Power BI) to align dashboard strategy',
        'Enablement: Train business users on dataset discovery via Unified Data Catalog & Governance and certified data usage',
      ...
      machine_learning: [
        'Workshop: Conduct a Model Lifecycle Management Workshop covering Enterprise Model Registry, Model Registry, and MLOps governance',
        'Enablement: Provide training for DS/ML teams on model versioning, experiment tracking, and deployment workflows',
        'Adoption: Select one business use case (e.g., fraud detection, churn prediction, or risk scoring) for Enterprise Model Registry deployment pilot',
      ...
      generative_ai: [
        ...
        'Partner / SI Engagement: Collaborate with GenAI implementation partners (Quantiphi, Enterprise Platform PS, or industry ISVs)',
  ...
  mapPainPointsToFeatures(painPoints, pillarId) {
    // Map pain points to specific Enterprise Platform features that solve them
    ...
    const featureMapByPillar = {
      platform_governance: {
        'poor_isolation': ['Unified Data Catalog & Governance', 'Workspace Administration', 'Private Link', 'IP Access Lists'],
        'quality_issues': ['Unified Data Catalog & Governance', 'Data Classification', 'Compliance Security Profile', 'Audit Logs'],
        'compliance_gaps': ['Unified Data Catalog & Governance', 'Audit Logs', 'Compliance Security Profile', 'Data Classification'],
        'compliance_risks': ['Unified Data Catalog & Governance', 'Audit Logs', 'Compliance Security Profile', 'Data Classification'],
        'weak_access_control': ['Unified Data Catalog & Governance', 'Service Principals', 'Attribute-Based Access Control', 'Row-Level Security'],
        'no_audit_logs': ['Audit Logs', 'System Tables', 'Unified Data Catalog & Governance Audit', 'Compliance Security Profile'],
        'manual_provisioning': ['Enterprise Platform Asset Bundles', 'Terraform Provider', 'Enterprise Platform CLI', 'Account Console'],
        'no_iac': ['Enterprise Platform Asset Bundles', 'Terraform Provider', 'Enterprise Platform CLI', 'Workspace API'],
      ...
      data_engineering: {
        ...
        'pipeline_failures': ['Declarative Data Pipelines', 'Workflows', 'Enterprise Platform Jobs', 'Alerting'],
        'manual_pipelines': ['Declarative Data Pipelines', 'Workflows', 'Enterprise Platform Jobs', 'Auto Loader'],
      ...
      'metric_inconsistency': ['Semantic Layer', 'Genie', 'Dashboards', 'Enterprise SQL Warehouse'],
      'no_shared_layer': ['Semantic Layer', 'Genie Spaces', 'Dashboards', 'SQL Warehouses'],
      'duplicate_logic': ['Semantic Layer', 'Genie', 'Enterprise SQL Warehouse', 'SQL Warehouses'],
      ...
      'conflicting_reports': ['Enterprise SQL Warehouse', 'Dashboards', 'Semantic Layer', 'Genie'],
      'trust_issues': ['Enterprise SQL Warehouse', 'Dashboards', 'Genie Spaces', 'Semantic Layer'],
      'decision_delays': ['Enterprise SQL Warehouse', 'Dashboards', 'Serverless SQL', 'Genie'],
      'wasted_effort': ['Semantic Layer', 'Genie', 'Dashboards', 'SQL Warehouses'],
      'compliance_risk': ['SQL Warehouses', 'Enterprise SQL Warehouse', 'Row-Level Security', 'Query History'],
      'poor_discoverability': ['Enterprise SQL Warehouse', 'Genie Spaces', 'Dashboards', 'SQL Warehouses'],
      'catalog_gaps': ['Enterprise SQL Warehouse', 'Genie Spaces', 'SQL Warehouses', 'Dashboards'],
      'unclear_lineage': ['Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses', 'Genie'],
      'access_complexity': ['SQL Warehouses', 'Serverless SQL', 'Enterprise SQL Warehouse', 'Partner Connect'],
      'quality_uncertainty': ['Enterprise SQL Warehouse', 'Dashboards', 'Genie', 'SQL Warehouses'],
      'integration_complexity': ['Partner Connect', 'Power BI Connector', 'Tableau Integration', 'Enterprise SQL Warehouse'],
      'performance_issues': ['Photon', 'Serverless SQL', 'Liquid Clustering', 'Result Caching'],
      'data_extracts': ['Partner Connect', 'Enterprise SQL Warehouse', 'SQL Warehouses', 'Serverless SQL'],
      'refresh_delays': ['Serverless SQL', 'Photon', 'Result Caching', 'SQL Warehouses'],
      'limited_interactivity': ['Enterprise SQL Warehouse', 'Dashboards', 'Genie', 'SQL Warehouses'],
      'stale_dashboards': ['Serverless SQL', 'Dashboards', 'SQL Warehouses', 'Enterprise SQL Warehouse'],
      'inconsistent_schedules': ['Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses', 'Workflows'],
      'kpi_proliferation': ['Semantic Layer', 'Genie', 'Dashboards', 'SQL Warehouses'],
      'version_control': ['Dashboards', 'Enterprise SQL Warehouse', 'SQL Warehouses', 'Genie'],
      'access_management': ['SQL Warehouses', 'Enterprise SQL Warehouse', 'Serverless SQL', 'Partner Connect'],
      'audit_trails': ['Query History', 'SQL Warehouses', 'Enterprise SQL Warehouse', 'Dashboards'],
      'conflicting_kpis': ['Semantic Layer', 'Dashboards', 'SQL Warehouses', 'Genie'],
      'report_sprawl': ['Dashboards', 'Enterprise SQL Warehouse', 'Genie Spaces', 'SQL Warehouses'],
      'trust_erosion': ['Enterprise SQL Warehouse', 'Dashboards', 'Semantic Layer', 'Genie'],
      'tool_complexity': ['Genie', 'Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses'],
      'access_barriers': ['SQL Warehouses', 'Serverless SQL', 'Partner Connect', 'Enterprise SQL Warehouse'],
      'training_gaps': ['Enterprise SQL Warehouse', 'Genie', 'Dashboards', 'SQL Warehouses'],
      'limited_tooling': ['Genie', 'Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses'],
      'support_burden': ['Genie', 'Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses'],
      'analyst_bottleneck': ['Genie', 'Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses'],
      'slow_decisions': ['Enterprise SQL Warehouse', 'Dashboards', 'Serverless SQL', 'Genie'],
      'low_data_literacy': ['Genie', 'Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses'],
      'missed_opportunities': ['Genie', 'Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses'],
      'security_gaps': ['SQL Warehouses', 'Enterprise SQL Warehouse', 'Serverless SQL', 'Row-Level Security'],
      'wild_west_access': ['SQL Warehouses', 'Enterprise SQL Warehouse', 'Row-Level Security', 'Serverless SQL'],
      'quality_control': ['Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses', 'Genie'],
      'audit_challenges': ['Query History', 'SQL Warehouses', 'Enterprise SQL Warehouse', 'Dashboards'],
      'policy_enforcement': ['SQL Warehouses', 'Enterprise SQL Warehouse', 'Serverless SQL', 'Row-Level Security'],
      'data_misuse': ['SQL Warehouses', 'Query History', 'Row-Level Security', 'Enterprise SQL Warehouse'],
      'regulatory_exposure': ['Enterprise SQL Warehouse', 'SQL Warehouses', 'Query History', 'Row-Level Security'],
      'inconsistent_analysis': ['Semantic Layer', 'Genie', 'Dashboards', 'SQL Warehouses'],
      'sharing_complexity': ['Partner Connect', 'Enterprise SQL Warehouse', 'SQL Warehouses', 'Delta Sharing'],
      'security_concerns': ['SQL Warehouses', 'Enterprise SQL Warehouse', 'Row-Level Security', 'Partner Connect'],
      'format_compatibility': ['Partner Connect', 'Enterprise SQL Warehouse', 'SQL Warehouses', 'Delta Sharing'],
      'access_provisioning': ['SQL Warehouses', 'Serverless SQL', 'Enterprise SQL Warehouse', 'Partner Connect'],
      'tracking_gaps': ['Query History', 'SQL Warehouses', 'Enterprise SQL Warehouse', 'Dashboards'],
      'partner_friction': ['Partner Connect', 'Power BI Connector', 'Tableau Integration', 'Enterprise SQL Warehouse'],
      'collaboration_barriers': ['Partner Connect', 'Enterprise SQL Warehouse', 'Delta Sharing', 'SQL Warehouses'],
      'revenue_impact': ['Partner Connect', 'Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses'],
      'competitive_disadvantage': ['Enterprise SQL Warehouse', 'Dashboards', 'Genie', 'Partner Connect'],
      'data_silos': ['Lakehouse Federation', 'Partner Connect', 'SQL Warehouses', 'Enterprise SQL Warehouse'],
      'join_performance': ['Photon', 'Liquid Clustering', 'Serverless SQL', 'SQL Warehouses'],
      'schema_conflicts': ['Lakehouse Federation', 'Enterprise SQL Warehouse', 'SQL Warehouses', 'Partner Connect'],
      'governance_gaps': ['SQL Warehouses', 'Enterprise SQL Warehouse', 'Row-Level Security', 'Query History'],
      'limited_insights': ['Enterprise SQL Warehouse', 'Dashboards', 'Genie', 'SQL Warehouses'],
      'integration_delays': ['Partner Connect', 'Lakehouse Federation', 'Enterprise SQL Warehouse', 'SQL Warehouses'],
      'duplicate_data': ['Lakehouse Federation', 'Enterprise SQL Warehouse', 'SQL Warehouses', 'Delta Sharing'],
      'monetization_barriers': ['Partner Connect', 'Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses'],
      'packaging_complexity': ['Partner Connect', 'Enterprise SQL Warehouse', 'Delta Sharing', 'SQL Warehouses'],
      'limited_reach': ['Partner Connect', 'Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses'],
      'value_capture': ['Partner Connect', 'Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses'],
        'market_readiness': ['Partner Connect', 'Enterprise SQL Warehouse', 'Dashboards', 'SQL Warehouses']
      },
      
      machine_learning: {
        'no_experiment_tracking': ['Enterprise Model Registry Tracking', 'Enterprise Model Registry Autologging', 'Experiments', 'Enterprise Model Registry UI'],
        'no_model_registry': ['Enterprise Model Registry Model Registry', 'Model Versioning', 'Model Aliases', 'Model Lineage'],
        'scattered_artifacts': ['Enterprise Model Registry Model Registry', 'Enterprise Model Registry Tracking', 'Experiments', 'Artifacts Store'],
        'no_model_monitoring': ['Model Serving Metrics', 'Model Monitoring', 'Inference Tables', 'Enterprise Model Registry'],
        'manual_retraining': ['Enterprise Model Registry Webhooks', 'Workflows', 'AutoML', 'Model Serving'],
        'no_feature_store': ['Feature Store', 'Online Tables', 'Feature Serving', 'Feature Engineering'],
        'model_failures': ['Model Serving', 'Model Monitoring', 'Inference Tables', 'Enterprise Model Registry']
      },
      ...
      generative_ai: {
        ...
        'prompt_management': ['AI Playground', 'Enterprise Model Registry', 'AI Gateway', 'Prompt Engineering'],
      ...
      operational_excellence: {
        'no_coe': ['Enterprise Platform Academy', 'Professional Services', 'Partner Network', 'Community'],
        'unclear_charter': ['System Tables', 'Account Console', 'Workspace Administration', 'Usage Analytics'],
        'resource_constraints': ['Enterprise Platform Academy', 'Professional Services', 'Community', 'Documentation'],
        'standards_gaps': ['Enterprise Platform Asset Bundles', 'Cluster Policies', 'Workspace Templates', 'Best Practices'],
        'adoption_challenges': ['Enterprise AI Advisor', 'Solution Accelerators', 'Enterprise Platform Academy', 'Community'],
        'no_training': ['Enterprise Platform Academy', 'Partner Training', 'Certification Programs', 'Learning Paths'],
    ...
    // 🔥 Get the feature map for THIS pillar ONLY
    const featureMap = featureMapByPillar[pillarId] || {};
    const features = new Set();
    
    // For each pain point, add relevant features FROM THIS PILLAR ONLY
  ...
  getFeatureDescription(featureName) {
    const descriptions = {
      ...
      'Continuous Data Observability': 'Monitor data quality, schema changes, and model performance',
      'Photon': 'High-performance query engine for 3-5x faster SQL and DataFrame queries',
      'Serverless SQL': 'Auto-scaling SQL warehouses with instant start and pay-per-query pricing',
      'Liquid Clustering': 'Automatic data layout optimization without manual Z-ordering',
      'Enterprise Model Registry': 'Open-source platform for ML lifecycle management',
      ...
      'Enterprise Platform Asset Bundles': 'Infrastructure as code for Enterprise Platform resources',
      'Feature Store': 'Centralized repository for ML features with point-in-time lookups',
      'Enterprise Platform Academy': 'Free online training and certification programs',
    ...
    return descriptions[featureName] || `${featureName} capability for Enterprise Platform`;
  }
  
  getFeatureBenefits(featureName) {
    const benefits = {
      'Unified Data Catalog & Governance': ['Centralized governance', 'Fine-grained access control', 'Data lineage', 'Cross-workspace sharing'],
      ...
      'Continuous Data Observability': ['Data quality monitoring', 'Drift detection', 'Automated alerting', 'Historical tracking'],
    ...
    return benefits[featureName] || ['Addresses identified challenges', 'Enterprise Platform managed service'];
  }
  ...
  generateStrategicRoadmap(prioritizedActions) {
    ...
    // Phase 1 (0-3 months): Foundation - Critical items + Unified Data Catalog & Governance (foundational)
    const phase1Items = [];
    const phase2Items = [];
    const phase3Items = [];
    
    // Always include Unified Data Catalog & Governance if there are governance/platform challenges
    ...
    if (hasGovernanceChallenges) {
      phase1Items.push('Implement Unified Data Catalog & Governance for centralized governance - reducing compliance risk and manual access management');
    }
    ...
    phase1CriticalPillars.slice(0, 2).forEach(pillar => {
      ...
      const topFeature = pillar.platformFeatures?.[0]?.name || 'recommended features';
    ...
    highPriorityPillars.slice(0, 2).forEach(pillar => {
      ...
      const topFeature = pillar.platformFeatures?.[1]?.name || pillar.platformFeatures?.[0]?.name || 'capabilities';
    ...
    if (maturePillars.length >= 3) {
      phase3Items.push('Align data mesh principles with Unified Data Catalog & Governance - enabling domain-oriented data ownership and reducing data silos');
    }
  ...
  calculateBusinessImpact(assessment, prioritizedActions, industry = 'Technology') {
    ...
    if (analyticsPillar) {
      ...
      const hasPhoton = analyticsPillar.platformFeatures?.some(f => 
    ...
    if (dataEngPillar) {
      ...
      const hasDLT = dataEngPillar.platformFeatures?.some(f => 
    ...
    if (platformPillar) {
      ...
      const hasServerless = platformPillar.platformFeatures?.some(f => 
      ...
      const hasBudgets = platformPillar.platformFeatures?.some(f => 
    ...
    if (dataEngPillar) {
      ...
      const hasAutomation = dataEngPillar.platformFeatures?.some(f => 
    ...
    if (mlPillar) {
      ...
      const hasMLOps = mlPillar.platformFeatures?.some(f => 
        f.name && (f.name.includes('Enterprise Model Registry') || f.name.includes('Model Serving'))
      );
      if (hasMLOps) {
    ...
    if (platformPillar) {
      ...
      // Bonus for Unified Data Catalog & Governance (reduces manual access management)
      const hasUnityCatalog = platformPillar.platformFeatures?.some(f => 
        f.name && f.name.includes('Unified Data Catalog & Governance')
      );
      if (hasUnityCatalog) {
        overheadReduction += 5; // +5% from Unified Data Catalog & Governance (down from 7%)
      }
    }
    ...
    if (mlPillar) {
      ...
      const hasFeatureStore = mlPillar.platformFeatures?.some(f => 
    ...
    if (genAIPillar) {
      ...
      const hasLLMs = genAIPillar.platformFeatures?.some(f => 
    ...
    if (dataEngPillar) {
      ...
      const hasDelta = dataEngPillar.platformFeatures?.some(f => 
      ...
      const hasDQ = dataEngPillar.platformFeatures?.some(f => 
    ...
    if (platformPillar) {
      ...
      // Bonus for Unified Data Catalog & Governance (lineage + governance - critical for compliance)
      const hasUnityCatalog = platformPillar.platformFeatures?.some(f => 
        f.name && f.name.includes('Unified Data Catalog & Governance')
      );
      if (hasUnityCatalog) {
        dataQuality += 8; // +8% from Unified Data Catalog & Governance (down from 10%)
      }
    }
    ...
    if (analyticsPillar) {
      const hasNotebooks = analyticsPillar.platformFeatures?.some(f => 
    ...
    if (opExPillar) {
      const hasWorkflows = opExPillar.platformFeatures?.some(f => 
    ...
    const impact = {
      ...
      manualOverhead: {
        ...
        drivers: [
          ...
          platformPillar ? 'Governance automation (Unified Data Catalog & Governance)' : null
        ].filter(Boolean).slice(0, 2)
      },
      timeToMarket: {
      ...
      dataQuality: {
        ...
        drivers: [
          ...
          platformPillar ? 'Unified Data Catalog & Governance governance & lineage' : null,
  ...
  buildContextualStrengths(assessment, pillarId, painPoints, comments, stateGaps, pillarFramework) {
    ...
    const pillarStrengths = {
      platform_governance: {
        basic: [
          allComments.includes('Unified Data Catalog & Governance') ? 'Unified Data Catalog & Governance deployed with centralized governance' : null,
      ...
      data_engineering: {
        basic: [
          ...
          allComments.includes('dlt') || allComments.includes('Declarative Data Pipelines') ? 'Declarative Data Pipelines for declarative ETL' : null,
      ...
      machine_learning: {
        basic: [
          allComments.includes('Enterprise Model Registry') ? 'Enterprise Model Registry for experiment tracking and model registry' : null,
  ...
  extractSpecificCapabilities(commentText) {
    ...
    if (text.includes('Unified Data Catalog & Governance')) return 'Unified Data Catalog & Governance deployed for governance';
    if (text.includes('Declarative Data Pipelines') || text.includes('dlt')) return 'Declarative Data Pipelines in production';
    if (text.includes('Enterprise Model Registry')) return 'Enterprise Model Registry for experiment tracking and model registry';
    ...
    if (text.includes('workflows')) return 'Enterprise Platform Workflows for orchestration';
    ...
    if (text.includes('Continuous Data Observability')) return 'Continuous Data Observability for data quality';
  ...
  getFeatureVerb(featureName) {
    const verbMap = {
      ...
      'Continuous Data Observability': 'Provides automated monitoring to prevent',
      ...
      // ML features
      'Enterprise Model Registry': 'Tracks ML experiments to avoid',
      ...
      // Platform Governance
      'Unified Data Catalog & Governance': 'Centralizes governance to eliminate',
