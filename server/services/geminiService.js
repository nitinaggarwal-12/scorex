...
class GeminiService {
  constructor() {
    ...
    // Fallback chain must contain only models that are still served. Gemini 1.5 (all
    // variants) and Gemini 2.0 Flash / Flash-Lite are retired and return 404, which meant
    // every primary-model failure silently walked four dead models before degrading.
    this.fallbackModels = ['gemini-3.6-flash', 'gemini-3.1-flash-lite'];
    this.client = null;
    this.initClient();
  }
