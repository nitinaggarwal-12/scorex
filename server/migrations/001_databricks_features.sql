-- Migration: Enterprise Platform Features Database Schema
-- Purpose: Store curated Enterprise Platform features for dynamic recommendation generation
-- Date: October 30, 2025

-- Table 1: Enterprise Platform Features (Core)
...
CREATE TABLE IF NOT EXISTS feature_technical_details (
    ...
    terraform_resource VARCHAR(255), -- e.g., "platform_sql_warehouse"
...
CREATE INDEX idx_features_ga_status ON platform_features(ga_status);
...
-- Comments
COMMENT ON TABLE platform_features IS 'Core Enterprise Platform features curated from official release notes';
